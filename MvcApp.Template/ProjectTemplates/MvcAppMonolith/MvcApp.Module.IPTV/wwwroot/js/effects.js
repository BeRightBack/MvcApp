...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const images = [
        "/_content/MvcApp.Module.IPTV/images/picstv-familly/image10.jpg",
        "/_content/MvcApp.Module.IPTV/images/picstv-familly/image11.jpg",
        "/_content/MvcApp.Module.IPTV/images/picstv-familly/image12.jpg",        
        "/_content/MvcApp.Module.IPTV/images/picstv-familly/image3.jpg",        
    ];
    ...
    function handleScroll() {
        ...
        if (window.scrollY > 0) {
            if (logo) logo.src = '/_content/MvcApp.Module.IPTV/Logos/logo-transparent-png.png';
        } else {
            if (logo) logo.src = '/_content/MvcApp.Module.IPTV/Logos/logo-transparent-wht.png';
        }
    }
