        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedUsers = table.Column<string>(type: "json", nullable: false),
                    LastTimeOnline = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    PremiumExpiryDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    MatchedWithUser = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsAvailable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ChatGroupID = table.Column<Guid>(type: "char(36)", nullable: false),
                    Introduction = table.Column<string>(type: "longtext", nullable: false),
                    LookingFor = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikedUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientUsername = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDetailsId1 = table.Column<string>(type: "varchar(255)", nullable: false),
