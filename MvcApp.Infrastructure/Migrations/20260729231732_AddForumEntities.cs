        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPostAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastPostByUserId = table.Column<string>(type: "longtext", nullable: true),
                    LastPostByUsername = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
